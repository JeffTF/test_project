                    ...
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const StepperText(text: 'date', isStep: true)
                        ],
                      ),
                    ),
                    GestureDetector(
                        ...
                        children: [
                          Row(
                            children: [
                              isTimeStep
                                  ? SvgPicture.asset(
                                      'assets/icons/time_step.svg')
                                  : SvgPicture.asset(
                                      'assets/icons/time_unstep.svg'),
                              StepLineContainer(
                                  lineWidth: lineWidth, isStep: isGuestStep)
                            ],
                          ),
                          StepperText(text: 'time', isStep: isTimeStep)
                        ],
                      ),
                    ),
                    GestureDetector(
                        ...
                        children: [
                          Row(
                            children: [
                              isGuestStep
                                  ? SvgPicture.asset(
                                      'assets/icons/guest_step.svg')
                                  : SvgPicture.asset(
                                      'assets/icons/guest_unstep.svg'),
                            ],
                          ),
                          StepperText(text: 'guest', isStep: isGuestStep)
                        ],
                      ),
                    ),
                  ],
      ...
      child: Center(
        child: Padding(
          ...
          child: FittedBox(
            child: Text(
              text,
              style: TextStyle(color: isStep ? Colors.black38 : Colors.white),
            ),
          ),
        ),
      ),
